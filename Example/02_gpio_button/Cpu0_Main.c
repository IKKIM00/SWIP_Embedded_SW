...
int core0_main(void)
{
    ...
    while(1)
    {
        ...
        {
            P10_OUT.U |= 0x1 << P1_BIT_LSB_IDX; // set P10.1 (LED D13 RED) --> switch ON
        }
        else{
            P10_OUT.U &= ~(0x1 << P1_BIT_LSB_IDX); // clear P10.1 (LED D13 RED) --> switch OFF
        }

        if((P02_IN.U & (0x1 << P0_BIT_LSB_IDX)) == 0) //P02.0 check button status
        {
            P10_OUT.U |= 0x1 << P2_BIT_LSB_IDX; // set P10.2 (LED D13 BLUE) --> switch ON
        }
        else{
            P10_OUT.U &= ~(0x1 << P2_BIT_LSB_IDX); // clear P10.2 (LED D13 BLUE) --> switch OFF
        }
